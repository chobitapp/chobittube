...
デプロイ先は Cloudflare Workers です。公開URLは [https://chobittube.nanabit.dev/](https://chobittube.nanabit.dev/) です。ストレージ（KV / D1 / R2）は使わず、YouTube への応答は Cache API で短時間キャッシュします。
